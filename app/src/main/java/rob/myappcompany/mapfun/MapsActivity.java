...
import rob.myappcompany.mapfun.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
     ...
     * we just add a marker near everest, Australia.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng everest = new LatLng(27.9886504180433, 86.92510381560467);
